...
<link rel="stylesheet" type="text/css" href="Css/gis/pumpPanel/table.css">


<script type="text/javascript" data-main="Js/pump/detail/index.js" src="Plugins/requireJs/require-2.1.11.js"></script>
<style type="text/css">
html {height: 100%;}
body {margin: 0; padding: 0; height: 100%;}
.commonQueryParamsPenel {}
#curveTab {height: 30px;}
.tabpage,.tabpage header ul{
	width:100%;
	height:100%;
	position: relative;
		...
		<div class="panel-box-container">
			<article class="tabpage">
				...
				<section>
					...
					<article class="">
						<div class="commonQueryParamsPenel" style="width:100%;">
							<span>开始时间</span>：
							<input id="qpStartTime" style="width:120px;">
							<span>结束时间</span>：
							<input id="qpEndTime" style="width:120px;">
							<button class="qpbtn" style="width:60px;">查询</button>
						</div>
						<div id="historyGrid" style="height:90%;width:100%">
					...
					<article class="">
						<div id="curveTab" style="width:100%">
		      		 	...
		      		 	<div id="curve" style="height:89%;width:100%">
		...
		<div id="tt" >   
		    ...
		    <div title="曲线" >
		    	<div style="height: 100%; position: relative;">
			        ...
			        <div id="curve" style="position: absolute;top: 30px; bottom: 0; right: 0; left: 0;">
