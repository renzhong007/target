define(['jquery', 'util','search/space/layerlist', 'search/property/resultlist'],function($, util, layerlist, rslist) {
	...
	function query() {
		...
		var drawType = $('#spaceSearch .spatial .search_way').find('.checked');
		
		f2net.window.BufferByDraw("PipeService",layers, "self.parent.require('search/space/query').setData",$(drawType).attr('target'));
	}
